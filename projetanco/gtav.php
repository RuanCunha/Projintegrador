			...
			<div class="container">
			  ...
			  <div class="mySlides">
			    <div class="numbertext">1 / 4</div>
			      <img src="images/gtav.jpg" style="width:70%">
			  </div>

			  <div class="mySlides">
			    <div class="numbertext">2 / 4</div>
			      <img src="images/gtav2.jpg" style="width:70%">
			  </div>

			  <div class="mySlides">
			    <div class="numbertext">3 / 4</div>
			      <img src="images/gtav3.jpg" style="width:70%">
			  </div>
			  <div class="mySlides">
			    <div class="numbertext">4 / 4</div>
			      <img src="images/gtav4.jpg" style="width:70%">
			  </div>
			  </div>
			  ...
			  <div class="row">
			    <div class="column">
			      <img class="demo cursor" src="images/gtav.jpg" style="width:100%" onclick="currentSlide(1)" alt="Protagonistas">
			    </div>
			    <div class="column"> 
			      <img class="demo cursor" src="images/gtav2.jpg" style="width:100%" onclick="currentSlide(2)" alt="Carros">
			    </div>
			    <div class="column">
			      <img class="demo cursor" src="images/gtav3.jpg" style="width:100%" onclick="currentSlide(3)" alt="Paisagens">
			    </div>
			    <div class="column"> 
			      <img class="demo cursor" src="images/gtav4.jpg" style="width:100%" onclick="currentSlide(4)" alt="Confrontos">
			    </div>
			    </div>
