			...
			<div class="container">
			  ...
			  <div class="mySlides">
			    <div class="numbertext">1 / 4</div>
			      <img src="images/farcry.jpg" style="width:70%">
			  </div>

			  <div class="mySlides">
			    <div class="numbertext">2 / 4</div>
			      <img src="images/farcry2.jpg" style="width:70%">
			  </div>

			  <div class="mySlides">
			    <div class="numbertext">3 / 4</div>
			      <img src="images/farcry3.jpg" style="width:70%">
			  </div>
			  <div class="mySlides">
			    <div class="numbertext">4 / 4</div>
			      <img src="images/farcry4.jpg" style="width:70%">
			  </div>
			  </div>
			  ...
			  <div class="row">
			    <div class="column">
			      <img class="demo cursor" src="images/farcry.jpg" style="width:100%" onclick="currentSlide(1)" alt="Caças">
			    </div>
			    <div class="column"> 
			      <img class="demo cursor" src="images/farcry2.jpg" style="width:100%" onclick="currentSlide(2)" alt="Paisagens">
			    </div>
			    <div class="column">
			      <img class="demo cursor" src="images/farcry3.jpg" style="width:100%" onclick="currentSlide(3)" alt="Personagens">
			    </div>
			    <div class="column"> 
			      <img class="demo cursor" src="images/farcry4.jpg" style="width:100%" onclick="currentSlide(4)" alt="Novas jogabilidades">
			    </div>
			    </div>
