...
?>
			...
			<div class="container">
			  ...
			  <div class="mySlides">
			    <div class="numbertext">1 / 4</div>
			      <img src="images/warframe.jpg" style="width:70%">
			  </div>

			  <div class="mySlides">
			    <div class="numbertext">2 / 4</div>
			      <img src="images/warframe2.jpg" style="width:70%">
			  </div>

			  <div class="mySlides">
			    <div class="numbertext">3 / 4</div>
			      <img src="images/warframe3.jpg" style="width:70%">
			  </div>
			  <div class="mySlides">
			    <div class="numbertext">4 / 4</div>
			      <img src="images/warframe4.jpg" style="width:70%">
			  </div>
			  </div>
			  ...
			  <div class="row">
			    <div class="column">
			      <img class="demo cursor" src="images/warframe.jpg" style="width:100%" onclick="currentSlide(1)" alt="Personagens">
			    </div>
			    <div class="column"> 
			      <img class="demo cursor" src="images/warframe2.jpg" style="width:100%" onclick="currentSlide(2)" alt="Paisagem">
			    </div>
			    <div class="column">
			      <img class="demo cursor" src="images/warframe3.jpg" style="width:100%" onclick="currentSlide(3)" alt="Ambientação">
			    </div>
			    <div class="column"> 
			      <img class="demo cursor" src="images/warframe4.jpg" style="width:100%" onclick="currentSlide(4)" alt="Confrontos">
			    </div>
			    </div>
			<div class="divider"></div>

			<p class="titulos">Gênero </p>
			<p class="caracteristicas">: Tiro em terceira pessoa</p>
			<div class='divider'></div>
			...
			<p class="caracteristicas">: 25/03/2013</p>
			<div class='divider'></div>
