			...
			<div class="container">
			  ...
			  <div class="mySlides">
			    <div class="numbertext">1 / 4</div>
			      <img src="images/ark.jpg" style="width:70%">
			  </div>

			  <div class="mySlides">
			    <div class="numbertext">2 / 4</div>
			      <img src="images/ark2.jpg" style="width:70%">
			  </div>

			  <div class="mySlides">
			    <div class="numbertext">3 / 4</div>
			      <img src="images/ark3.jpg" style="width:70%">
			  </div>
			  <div class="mySlides">
			    <div class="numbertext">4 / 4</div>
			      <img src="images/ark4.jpg" style="width:70%">
			  </div>
			  </div>
			  ...
			  <div class="row">
			    <div class="column">
			      <img class="demo cursor" src="images/ark.jpg" style="width:100%" onclick="currentSlide(1)" alt="Exploração">
			    </div>
			    <div class="column"> 
			      <img class="demo cursor" src="images/ark2.jpg" style="width:100%" onclick="currentSlide(2)" alt="Confrontos">
			    </div>
			    <div class="column">
			      <img class="demo cursor" src="images/ark3.jpg" style="width:100%" onclick="currentSlide(3)" alt="Caças">
			    </div>
			    <div class="column"> 
			      <img class="demo cursor" src="images/ark4.jpg" style="width:100%" onclick="currentSlide(4)" alt="Dinossauros">
			    </div>
			    </div>
